...
[[Helper functions][helper function]] overrides this for the given number of bars.
...
in /chucklib/'s =Func= collection. This makes it easier to use 
[[Helper functions][helper functions]]. No syntax checking is done in the preprocessor.
