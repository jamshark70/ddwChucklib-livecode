...
placeholders) are equally spaced throughout the bar. If there are
dividers, the measure's duration will be divided first: $n$ dividers
produces $n+1$ units. Then, within each division, items will be
equally spaced. The spacing is independent for each division. For
example, in #6 below, the first division contains one item, but the
second contains two. For all the divisions to have the same duration,
then, =-= in the second division should be half as long as in the
first.
...
| 4 | \texttt{"- --- -"}                                    | 7(QEEQE)   |
|---+-------------------------------------------------------+------------|
| 5 | \texttt{"-\textbar-\textbar-\textbar-"}               | QQQQ       |
|---+-------------------------------------------------------+------------|
| 6 | \texttt{"-\textbar--\textbar-\textbar-"}              | QEEQQ      |
|---+-------------------------------------------------------+------------|
| 7 | \texttt{"--\textbar \ -\ \ \textbar- --\textbar \ -"} | EE.E.ESE.E |
|---+-------------------------------------------------------+------------|
