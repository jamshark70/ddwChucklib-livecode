...
can appear within pool strings. These are treated as subpatterns in
the SC pattern system: \linebreak
=\rand("\seq("123")\seq("543")\seq("678")")=
will randomly choose among the three phrases defined by the =\seq()=
members. See Listing [[genSequencers]].
